...
Re-run after changing RANDOM_BASE; all statistics update in metrics.json (LaTeX table
fragments are not written — consume JSON from your analysis or reporting tools).
"""
